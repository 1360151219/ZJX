...
###肝项目
没什么好写的今天。。。睡了一上午，下午去实验室发现因为考六级封楼了，晚上赶了一晚上的项目。

##6.13

###JDBC
今天早上十点的会取消了，好家伙！我直接开始JDBC，今天看了一半多的内容，前面都是跟着老师手撸java对数据库的增删改查代码。

明天大概能看完剩下的内容，然后打算下午剩下的时间就去写博客总结一下JDBC的内容，晚上就去开始复习计网。

感觉JDBC的内容也不多，主要是对一些API的了解和使用，在后面学习的mybatis能提供多少便捷也不太了解。